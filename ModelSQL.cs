...
namespace Homework17version1._1
{
    ...
    {
        public ModelSQL(string LastName, string Name, string MiddleName, string NumberTelephone, string Email)
        {
        ...
        {
            return $"{LastName,15}{Name,15}{MiddleName,15}{NumberTelephone,15}{Email,15}";
        }
    }
}
